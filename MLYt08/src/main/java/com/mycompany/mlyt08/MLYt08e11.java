 ...
 * 18/1/2023
 *
 * @author marta.lopezyanez Crear una clase llamada Trabajador con los atributos
 * privados: id, nombre, fecha de nacimiento y salario base. • Dispondrá también
 * de un constructor que inicialice todos sus campos, getters, setters, método
 ...
 * ConsultoresExternos e introduce “a mano” dos o tres empleados en ambos
 * ArrayList. o Después modifica el contenido de ambos ArrayList añadiendo
 * también “a mano” las horas extra/horas trabajadas respectivamente para todos
 * los empleados. o Fijar el importe de hora extra a 20 euros y la hora de
 * consultor a 100 euros y modificar de nuevo los ArrayList calculando el
 * salario final de cada trabajador. o Finalmente, recorriendo con un for-each
 * ambos ArrayList, obtener el total que gastará la empresa en salarios. o
 * ¿Sería útil tener un ArrayList que pudiese contener instancias de ambas
 * clases?
 */
public class MLYt08e11 {
    ...
    public static void main(String[] args) {
        ...
        for (ConsultorExterno cE : consultoresexternos) {
            float salario = cE.calcularSalarioFinal(100);
            cE.toString();
            System.out.print("Su salario total es: " + salario);
            gastoSalarios += salario;
        }
