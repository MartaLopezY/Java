 ...
 */
public class MLYt16e05a {

    public static void main(String[] args) {
         Scanner teclado = new Scanner(System.in);
        System.out.println("Introduce la matricula de coche (NNNN LLL): ");
             String matricula = teclado.nextLine();
             String regexp="\\d{4}^w{3}";
             if(matricula.matches(regexp))   System.out.println("La matricula es correcta");
